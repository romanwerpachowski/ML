...
namespace ml
{
    ...
    */
    ...
    private:
        ...
        Eigen::MatrixXd data_; /**< Ball tree data. */
        std::unique_ptr<Node> root_; /**< Ball tree root. */
        unsigned int min_split_size_;

        /**
         * @brief Recursively constructs a ball tree.
         * @param work Work block (a view on data_), containing the feature vectors being processed.
        ...
        */
        void construct(Eigen::Ref<Eigen::MatrixXd> work, unsigned int offset, std::unique_ptr<Node>& node, Features::VectorRange<Features::IndexedFeatureValue> features);
