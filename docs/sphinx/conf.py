...
project = 'cppyml'
copyright = '2020, Roman Werpachowski'
...
latex_documents = [
    (master_doc, 'cppyml.tex', 'cppyml Documentation',
     'Roman Werpachowski', 'manual'),
]
...
man_pages = [
    (master_doc, 'cppyml', 'cppyml Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'cppyml', 'cppyml Documentation',
     author, 'cppyml', 'One line description of project.',
     'Miscellaneous'),
]
